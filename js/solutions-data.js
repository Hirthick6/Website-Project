...
const SOLUTIONS_DATA = [
  {
    ...
    packages: [
      { name: 'Starter Project', price: 'small scale solutions', tag: '', features: ['Single Module Application', 'Responsive Design', 'Basic API Integration', '3 Months Support', 'Source Code Delivery'] },
      { name: 'Business Project', price: 'Ideal for growing businesses', tag: 'MOST POPULAR', features: ['Multi-Module Application', 'Custom UI/UX Design', 'Advanced API Integration', 'Admin Dashboard', '6 Months Support', 'Cloud Deployment'] },
      { name: 'Enterprise Project', price: 'large scale systems', tag: '', features: ['Enterprise-Grade System', 'Microservices Architecture', 'Third-Party Integrations', 'Real-Time Analytics', '12 Months Support', 'Dedicated Team'] }
    ],
    faqs: [
  ...
  },
  {
    ...
    packages: [
      { name: 'Mini Project', price: 'small scale projects', tag: '', features: ['Basic Application', 'Source Code', 'Project Report', 'Demo Support', 'Email Support'] },
      { name: 'Final Year Project', price: 'Ideal for final year projects', tag: 'MOST POPULAR', features: ['Full Application', 'Complete Source Code', 'IEEE Format Documentation', 'Presentation Slides', 'Viva Preparation', '2 Revisions'] },
      { name: 'Research Project', price: 'Large scale projects', tag: '', features: ['Novel Implementation', 'Research Paper', 'Journal Publication Guidance', 'Complete Documentation', 'Unlimited Revisions'] }
    ],
    faqs: [
  ...
  },
  {
    ...
    packages: [
      { name: 'Starter AI Agent', price: 'Small scale automation solutions', tag: '', features: ['Basic Conversational AI', 'Single Platform Integration', 'Pre-trained NLP Models', 'Basic Analytics Dashboard', '3 Months Support', 'Documentation & Training'] },
      { name: 'Business AI Agent', price: 'Ideal for smart business systems', tag: 'MOST POPULAR', features: ['Advanced Conversational AI', 'Multi-platform Integration', 'Custom ML Models', 'Advanced Analytics', 'Process Automation', '6 Months Support'] },
      { name: 'Enterprise AI Agent', price: 'Large scale AI platforms', tag: '', features: ['Enterprise-grade AI', 'Full System Integration', 'Custom Deep Learning', 'Real-time Analytics', 'Multi-agent System', '12 Months Support'] }
    ],
    faqs: [
  ...
  },
  {
    ...
    packages: [
      { name: '1 Month Internship', price: 'Beginner level learning programs', tag: '', features: ['1 Technology Track', 'Mini Project', 'Basic Certification', 'Online Sessions', 'Email Support'] },
      { name: '3 Month Internship', price: 'Ideal for practical experience', tag: 'MOST POPULAR', features: ['2 Technology Tracks', 'Live Client Project', 'Advanced Certification', 'Mentorship', 'Placement Assistance', 'Letter of Recommendation'] },
      { name: '6 Month Internship', price: 'Advanced industry internships', tag: '', features: ['Multiple Tracks', 'Multiple Projects', 'Industry Certification', 'Dedicated Mentor', 'Guaranteed Placement', 'Stipend Eligible'] }
    ],
    faqs: [
  ...
  },
  {
    ...
    packages: [
      { name: 'Basic Website', price: 'Small scale business websites', tag: '', features: ['5 Pages', 'Responsive Design', 'Contact Form', 'Basic SEO', 'SSL Certificate', '1 Month Support'] },
      { name: 'Business Website', price: 'Ideal for growing brands', tag: 'MOST POPULAR', features: ['15 Pages', 'Custom Design', 'CMS Integration', 'Advanced SEO', 'Analytics Setup', '3 Months Support'] },
      { name: 'E-Commerce Website', price: 'Large scale web platforms', tag: '', features: ['Unlimited Products', 'Payment Gateway', 'Inventory System', 'Order Management', 'Marketing Tools', '6 Months Support'] }
    ],
    faqs: [
  ...
  },
  {
    ...
    packages: [
      { name: 'Starter', price: 'Small scale digital products', tag: '', features: ['Up to 10 Users', 'Core Features', 'Email Support', 'Basic Analytics', 'Cloud Hosted', 'Monthly Updates'] },
      { name: 'Professional', price: 'Ideal for scalable solutions', tag: 'MOST POPULAR', features: ['Up to 50 Users', 'All Features', 'Priority Support', 'Advanced Analytics', 'Custom Branding', 'API Access'] },
      { name: 'Enterprise', price: 'Large scale AI products', tag: '', features: ['Unlimited Users', 'Custom Features', 'Dedicated Support', 'On-Premise Option', 'SLA Guarantee', 'Dedicated Manager'] }
    ],
    faqs: [
  ...
  },
  {
    ...
    packages: [
      { name: 'Starter', price: 'Small scale business services', tag: '', features: ['Single Service', 'Basic Scope', '1 Month Duration', 'Email Support', 'Documentation'] },
      { name: 'Growth', price: 'Ideal for growth solutions', tag: 'MOST POPULAR', features: ['Multiple Services', 'Custom Scope', '3 Month Duration', 'Priority Support', 'Monthly Reports', 'Dedicated Manager'] },
      { name: 'Enterprise', price: 'Large scale enterprise services', tag: '', features: ['All Services', 'Unlimited Scope', 'Ongoing Partnership', '24/7 Support', 'SLA Guarantee', 'Dedicated Team'] }
    ],
    faqs: [
  ...
  },
  {
    ...
    packages: [
      { name: 'Single Course', price: 'Beginner level learning paths', tag: '', features: ['1 Course Access', 'Video Lectures', 'Assignments', 'Certificate', 'Lifetime Access'] },
      { name: 'Learning Path', price: 'Ideal for skill development', tag: 'MOST POPULAR', features: ['5 Course Bundle', 'Structured Path', 'Live Doubt Sessions', 'Projects', 'Mentorship', 'Career Guidance'] },
      { name: 'All Access Pass', price: 'Advanced career programs', tag: '', features: ['All Courses', 'All Bootcamps', 'Priority Support', 'Unlimited Projects', '1-on-1 Mentorship', 'Placement Support'] }
    ],
    faqs: [
