...
const SOLUTIONS_DATA = [
  {
    ...
    techStack: [
      { title: 'Frontend Technologies', desc: 'Modern UI frameworks for responsive, interactive user experiences.', tags: ['React', 'Next.js', 'Vue.js', 'Angular', 'TypeScript', 'Tailwind CSS'] },
      { title: 'Backend Technologies', desc: 'Scalable server-side solutions for robust business logic.', tags: ['Node.js', 'Python', '.NET', 'Java', 'Spring Boot', 'Django', 'FastAPI', 'Express.js', 'Go', 'Rust'] },
      { title: 'Mobile Technologies', desc: 'Cross-platform and native mobile development frameworks.', tags: ['React Native', 'Flutter', 'Swift', 'Kotlin'] },
      { title: 'Database Technologies', desc: 'Robust database solutions for data storage and management.', tags: ['PostgreSQL', 'MongoDB', 'MySQL', 'Redis', 'Firebase', 'SQLite'] },
      { title: 'Cloud & DevOps', desc: 'Cloud-native deployment and CI/CD automation.', tags: ['AWS', 'Docker', 'Kubernetes', 'Google Cloud', 'Azure', 'CI/CD', 'Terraform', 'Jenkins'] }
    ],
    process: [
  ...
  },
  {
    ...
    coursesPricing: [
      ...
      {
        category: 'Game Development (3D & 2D)', courses: [
  ...
  },
  {
    ...
    techStack: [
      {
        title: 'AI & Machine Learning', desc: 'We integrate AI into your existing platforms static or dynamic delivering chatbots, voice assistants, RAG systems, computer vision, GenAI, NLP and OpenCV-powered products tailored to your business.', tags: [
          ...
          { name: 'GenAI', logo: 'https://img.icons8.com/color/48/chatgpt.png' },
      ...
      { title: 'Web Technologies', desc: 'Full-stack projects with modern web frameworks.', tags: ['React', 'Django', 'Node.js', 'MongoDB'] },
      {
        title: 'IoT & Embedded', desc: 'Hardware-integrated projects with sensors and microcontrollers.', tags: [
          ...
          { name: 'MQTT', logo: 'data:image/svg+xml;base64,' },
